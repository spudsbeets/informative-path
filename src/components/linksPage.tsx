...
const LinksPage = () => {
    return(
        ...
        <section className="flex flex-wrap justify-around bg-videoGameGreen border-borderGreen border-8 h-screen/65 w-screen/90 items-center gap-2 px-4 py-4 my-4">
              ...
              <a href="https://www.linkedin.com/in/sean-miller-6a5b51290" target="_blank"><img className="max-w-24 max-h-20 hover:opacity-60 bg-borderGreen p-3 rounded-md md:max-w-32 md:max-h-28 lg:max-w-40 lg:max-h-36 xl:max-w-52 xl:max-h-44" src="./src/images/linkedin.png" alt="linkedin" /></a>
