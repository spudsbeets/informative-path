...
const CodeOpener = () => {
    ...
    <section className="mx-auto text-center w-screen/80 h-screen/65 bg-videoGameGreen self-center border-borderGreen border-8 flex-col flex-nowrap rounded-md justify-between flex lg:grid lg:grid-cols-3 lg:grid-rows-3">
        <Link to="/codePage" rel="noreferrer"><h2 className="text-2xl underline text-blue-600 hover:text-blue-800 lg:text-4xl lg:col-start-1 lg:row-start-1 lg:row-span-2 lg:place-self-center lg:pl-10 lg:pt-20">CODE</h2></Link>
        ...
        <p className="text-md lg:text-xl lg:col-start-1 lg:row-start-3 lg:pl-10">check out some coding projects i've put together</p>
    </section>
    )
 }
