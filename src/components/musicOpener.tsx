...
const MusicOpener = () => {
   ...
   return(
    ...
    <Link to="/musicPage" rel="noreferrer"><h2 className="text-2xl underline text-blue-600 hover:text-blue-800 lg:text-4xl lg:col-start-1 lg:row-start-1 lg:row-span-2 lg:place-self-center lg:pl-10 lg:pt-20">MUSIC</h2></Link>
    ...
    <p className="text-md lg:text-xl lg:col-start-1 lg:row-start-3 lg:pl-10">check out some songs i've made</p>
    </section>
   )
}
