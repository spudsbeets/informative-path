...
const CodePage = () => {
    return(
        ...
        <video src="./src/videos/spudintransitvid.mp4" autoPlay muted loop className="min-w-48 max-w-48 min-h-40 max-h-40 md:min-w-80 md:max-w-80 md:min-h-64 md:max-h-64 lg:min-w-[26rem] lg:max-w-[26rem] lg:min-h-80 lg:max-h-80 pSm:min-w-40 pSm:max-w-40 pSm:min-h-32 pSm:max-h-32 vSm:min-w-36 vSm:max-w-36 vSm:min-h-28 vSm:max-h-28"></video>
        </div>
        ...
        <section className="grid grid-cols-2 grid-rows-3 bg-videoGameGreen border-borderGreen border-8 h-screen/30 w-screen/90 items-center gap-2 pl-2 my-4 md:h-screen/40">
        <div className="row-start-1 row-span-3 col-start-1 h-full flex flex-col justify-center items-center min-w-48 max-w-48 min-h-40 max-h-40 md:min-w-80 md:max-w-80 md:min-h-64 md:max-h-64 lg:min-w-[26rem] lg:max-w-[26rem] lg:min-h-80 lg:max-h-80 xl:pl-12 pSm:min-w-40 pSm:max-w-40 pSm:min-h-32 pSm:max-h-32 vSm:min-w-36 vSm:max-w-36 vSm:min-h-28 vSm:max-h-28">
        <video src="./src/videos/cocktailclashvid.mp4" autoPlay muted loop className="min-w-48 max-w-48 min-h-40 max-h-40 md:min-w-80 md:max-w-80 md:min-h-64 md:max-h-64 lg:min-w-[26rem] lg:max-w-[26rem] lg:min-h-80 lg:max-h-80 pSm:min-w-40 pSm:max-w-40 pSm:min-h-32 pSm:max-h-32 vSm:min-w-36 vSm:max-w-36 vSm:min-h-28 vSm:max-h-28"></video>
        </div>
        <div className="col-start-2 row-start-1 row-span-3 flex flex-col flex-nowrap h-full justify-around pr-2">
         <a href="linkToGame"><h2 className="text-sm text-center underline text-blue-800 hover:text-blue-600 md:text-lg xl:text-xl vSm:text-xs">Cocktail Clash</h2></a>
        ...
        <section className="grid grid-cols-2 grid-rows-3 bg-videoGameGreen border-borderGreen border-8 h-screen/30 w-screen/90 items-center gap-2 pl-2 my-4 md:h-screen/40">
        <div className="row-start-1 row-span-3 col-start-1 h-full flex flex-col justify-center items-center min-w-48 max-w-48 min-h-40 max-h-40 md:min-w-80 md:max-w-80 md:min-h-64 md:max-h-64 lg:min-w-[26rem] lg:max-w-[26rem] lg:min-h-80 lg:max-h-80 xl:pl-12 pSm:min-w-40 pSm:max-w-40 pSm:min-h-32 pSm:max-h-32 vSm:min-w-36 vSm:max-w-36 vSm:min-h-28 vSm:max-h-28">
        <video src="spudsShipVid" autoPlay muted loop className="min-w-48 max-w-48 min-h-40 max-h-40 md:min-w-80 md:max-w-80 md:min-h-64 md:max-h-64 lg:min-w-[26rem] lg:max-w-[26rem] lg:min-h-80 lg:max-h-80 pSm:min-w-40 pSm:max-w-40 pSm:min-h-32 pSm:max-h-32 vSm:min-w-36 vSm:max-w-36 vSm:min-h-28 vSm:max-h-28"></video>
        </div>
        <div className="col-start-2 row-start-1 row-span-3 flex flex-col flex-nowrap h-full justify-around pr-2">
         <a href="linkToGame"><h2 className="text-sm text-center underline text-blue-800 hover:text-blue-600 md:text-lg xl:text-xl vSm:text-xs">Spud's Ship</h2></a>
        ...
        <section className="grid grid-cols-2 grid-rows-3 bg-videoGameGreen border-borderGreen border-8 h-screen/30 w-screen/90 items-center gap-2 pl-2 my-4 md:h-screen/40">
        <div className="row-start-1 row-span-3 col-start-1 h-full flex flex-col justify-center items-center min-w-48 max-w-48 min-h-40 max-h-40 md:min-w-80 md:max-w-80 md:min-h-64 md:max-h-64 lg:min-w-[26rem] lg:max-w-[26rem] lg:min-h-80 lg:max-h-80 xl:pl-12 pSm:min-w-40 pSm:max-w-40 pSm:min-h-32 pSm:max-h-32 vSm:min-w-36 vSm:max-w-36 vSm:min-h-28 vSm:max-h-28">
        <video src="./src/videos/tuesdaysnipsvid.mp4" autoPlay muted loop className="absolute min-w-48 max-w-48 min-h-40 max-h-40 animate-opacity-shift-2pics-1 pb-6 md:min-w-80 md:max-w-80 md:min-h-64 md:max-h-64 lg:min-w-[26rem] lg:max-w-[26rem] lg:min-h-80 lg:max-h-80 pSm:min-w-40 pSm:max-w-40 pSm:min-h-32 pSm:max-h-32 vSm:min-w-36 vSm:max-w-36 vSm:min-h-28 vSm:max-h-28"></video>
        <video src="./src/videos/wednesdaysnipsvid.mp4" autoPlay muted loop className="absolute min-w-48 max-w-48 min-h-40 max-h-40 animate-opacity-shift-2pics-2 pb-6 md:min-w-80 md:max-w-80 md:min-h-64 md:max-h-64 lg:min-w-[26rem] lg:max-w-[26rem] lg:min-h-80 lg:max-h-80 pSm:min-w-40 pSm:max-w-40 pSm:min-h-32 pSm:max-h-32 vSm:min-w-36 vSm:max-w-36 vSm:min-h-28 vSm:max-h-28"></video>
        ...
        <div className="col-start-2 row-start-1 row-span-3 flex flex-col flex-nowrap h-full justify-around pr-2">
         <a href="linkToSnips"><h2 className="text-sm text-center underline text-blue-800 hover:text-blue-600 md:text-lg xl:text-xl vSm:text-xs">Spud's Snips</h2></a>
        ...
        <section className="flex flex-col bg-videoGameGreen border-borderGreen border-8 h-screen/30 w-screen/90 items-center my-4 md:h-[50%]">
            ...
            <img className="w-16 h-16 mt-2 bg-borderGreen p-3 rounded-md md:w-28 md:h-28" src="./src/images/git.png" alt="git" />
            <img className="w-16 h-16 mt-2 bg-borderGreen p-3 rounded-md md:w-28 md:h-28" src="./src/images/js.png" alt="js" />
            <img className="w-16 h-16 mt-2 bg-borderGreen p-3 rounded-md md:w-28 md:h-28" src="./src/images/react.png" alt="react" />
            <img className="w-16 h-16 mt-2 bg-borderGreen p-3 rounded-md md:w-28 md:h-28" src="./src/images/ts.png" alt="ts" />
            <img className="w-30 h-16 mt-2 bg-borderGreen p-3 rounded-md md:w-44 md:h-28" src="./src/images/htmlcss.png" alt="htmlcss" />
            <img className="w-30 h-16 mt-2 bg-borderGreen p-3 rounded-md md:w-44 md:h-28" src="./src/images/tailwind.png" alt="tailwind" />
            </div>
        </section>
